...
#    Updated: 2018/10/26 22:54:58 by ybokina          ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SOURCES := main.c ft_env1.c ft_display.c ft_line.c ft_symbols.c ft_actions.c ft_error1.c ft_error2.c ft_core.c ft_free.c ft_build_in.c ft_cd.c ft_path.c ft_execution.c ft_cd2.c ft_error3.c ft_cd3.c ft_setenv.c ft_env2.c ft_unsetenv.c ft_error4.c ft_error5.c ft_terminal.c ft_error6.c ft_termcap.c ft_keyboard1.c ft_keyboard2.c
